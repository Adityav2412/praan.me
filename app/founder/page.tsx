    ...
    <>
      <main className="min-h-screen bg-cream overflow-x-hidden">
        ...
        <section className="relative min-h-screen bg-cream px-6 md:px-12 lg:px-24 pt-32 pb-24">
          ...
          <a
            href="/"
            className="inline-flex items-center gap-2 text-navy/50 hover:text-navy transition-colors mb-12 text-sm font-body font-medium"
          >
          ...
          <div ref={contentRef} className={`relative max-w-6xl mx-auto motion-reveal ${isVisible ? 'is-visible' : ''}`}>
            ...
            <div className="relative z-20 max-w-2xl">
              {/* Heading */}
              <h1 className="text-5xl md:text-7xl font-display font-bold text-navy mb-2 leading-none tracking-tight">
                Hello 👋
              </h1>

              {/* Intro */}
              <p className="text-base md:text-lg font-body font-bold text-navy mb-4 md:mb-10">
                I&apos;m Akshay{' '}
              ...
              {/* Body */}
              <div className="space-y-6 text-navy/80 text-base md:text-[17px] leading-[1.95] font-body font-normal">
                <p>
              ...
              {/* Quote */}
              <blockquote className="border-l-[3px] border-navy-light pl-6 my-10">
                <p className="text-navy font-display font-semibold italic text-base md:text-[18px] leading-[1.8]">
              ...
              {/* Divider */}
              <div className="w-10 h-[3px] bg-navy-light rounded-full mb-10" />

              {/* Why Praan */}
              <h2
                id="why-praan"
                className="text-2xl md:text-3xl font-display font-bold text-navy mb-5"
              >
                Why Praan?
              </h2>
              ...
              <div className="mt-12 pt-8 border-t border-navy/10">
                <p className="text-navy/50 italic text-sm font-body mb-3">
                ...
                <p className="text-navy font-bold text-base font-body">Akshay</p>

                <p className="text-navy/50 text-sm mt-0.5 font-body">
                  Founder, PRAAN 💙
                </p>
              </div>
              ...
              <div className="mt-8 flex flex-wrap items-center gap-4">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-navy-light text-cream text-sm font-body font-semibold px-6 py-3 rounded-full hover:opacity-90 transition-colors motion-cta"
                >
                  Let&apos;s Talk →
                </a>
            ...
            {/* RIGHT EDITORIAL PORTRAIT — desktop layout */}
