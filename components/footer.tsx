      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-6">
          <Image
            ...
            className="w-16 h-16"
          />
          <span className="text-2xl font-extrabold">Water For Wings</span>
        </div>
        ...
        {/* Hashtag */}
        <p className="text-navy-light font-semibold mb-6">#DelhiBirdsNeedWater</p>

        {/* Social Links */}
        <div className="flex items-center justify-center gap-6 mb-8">
          <a
            href="https://instagram.com/waterforwings"
            target="_blank"
